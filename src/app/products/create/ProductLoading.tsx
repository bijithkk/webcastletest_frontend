// src/app/products/create/ProductLoading.tsx
"use client";
      ...
      <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center">
        <div className="bg-white p-6 rounded-lg max-w-md w-full">
          <div className="flex flex-col justify-center items-center h-64 gap-2">
            ...
            <p className="text-green-500 font-medium">Product created successfully!</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center">
        <div className="bg-white p-6 rounded-lg max-w-md w-full">
          <div className="flex flex-col gap-2 justify-center items-center h-64">
            ...
            <p className="text-red-500 font-medium">Creating product...</p>
          </div>
        </div>
      </div>
    );
